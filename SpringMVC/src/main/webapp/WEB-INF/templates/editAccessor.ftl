            ...
            <tr>
                ...
                <td>
                    <label><input name="xPermits" value="EXECUTE_PROC" title="Execute Procedure" type="checkbox"
                                  <#if accessor.getXPermits()?contains("EXECUTE_PROC")>checked</#if>/>Execute Procedure
                        (EP)</label><br>
                    ...
                    <label><input name="xPermits" value="CHANGE_OWNER" title="Change Ownership" type="checkbox"
                                  <#if accessor.getXPermits()?contains("CHANGE_OWNER")>checked</#if>/>Change Ownership
                        (CO)</label><br>
                    <label><input name="xPermits" value="DELETE_OBJECT" title="Extended Delete" type="checkbox"
                                  <#if accessor.getXPermits()?contains("DELETE_OBJECT")>checked</#if>/>Extended Delete
                        (DO)</label><br>
                    <label><input name="xPermits" value="CHANGE_FOLDER_LINKS" title="Change Folder Links"
                                  type="checkbox"
                                  <#if accessor.getXPermits()?contains("CHANGE_FOLDER_LINKS")>checked</#if>/>Change
                        Folder
                        Links (CFL)</label><br>
                </td>
                <td>
